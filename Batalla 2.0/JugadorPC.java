...
public class JugadorPC extends Jugador {
    ...
    protected boolean yaDisparo(Coordenada c) {
        String clave = c.getFila() + "," + c.getColumna();
        return disparosRealizados.contains(clave);
    }

    protected void marcarDisparo(Coordenada c) {
        String clave = c.getFila() + "," + c.getColumna();
        disparosRealizados.add(clave);
    }
